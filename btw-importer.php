...
class Btw_Importer {
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_btw_importer_prepare_import', [$this, 'ajax_prepare_import']);
        add_action('wp_ajax_btw_importer_import_single_post', [$this, 'ajax_import_single_post']);
    }

    public function add_menu() { // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query
        add_menu_page( // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query
            ...
            'btw-importer', [$this, 'import_page'], 'dashicons-upload' // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_query
        );
    }
